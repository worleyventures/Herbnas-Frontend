...
import {
  ...
  selectPaymentVerificationStats,
  selectPaymentVerificationStatsLoading
...
const OrdersPage = () => {
  ...
  const paymentVerifications = useSelector(selectPaymentVerifications);
  const paymentVerificationLoading = useSelector(selectPaymentVerificationLoading);
  const paymentVerificationError = useSelector(selectPaymentVerificationError);
  const paymentVerificationPagination = useSelector(selectPaymentVerificationPagination);
  ...
  useEffect(() => {
    ...
    // Load payment verifications if user can view them
    if (canViewVerifications) {
      dispatch(getAllPaymentVerifications({
        page: verificationPage,
        limit: 10,
        status: verificationStatusFilter === 'all' ? '' : verificationStatusFilter,
        search: verificationSearchTerm || undefined
      }));
      dispatch(getPendingVerificationCount());
      dispatch(getPaymentVerificationStats());
    }
  }, [dispatch, currentPage, searchTerm, paymentStatusFilter, statusFilter, isSalesExecutive, isAdmin, user?._id, canViewVerifications, verificationPage, verificationStatusFilter, verificationSearchTerm]);
  
  // Refresh pending count periodically
  useEffect(() => {
    if (!canViewVerifications) return;
  ...
  const formatVerificationCurrency = (amount) => {
  ...
  const verificationColumns = [
      ...
      render: (verification) => (
        <div className="text-sm">
          ...
          <div className="text-gray-600">
            <span className="font-medium">Amount:</span> {formatVerificationCurrency(verification.currentAmountReceived)}
          </div>
        </div>
      )
    },
      ...
      render: (verification) => (
        <div className="text-sm">
          ...
          <div className="text-green-600">
            <span className="font-semibold">Amount:</span> {formatVerificationCurrency(verification.requestedAmountReceived)}
          </div>
        </div>
      )
    },
    ...
    },
    {
      ...
      render: (verification) => (
        <div className="text-sm text-gray-500">
          {formatVerificationDate(verification.createdAt)}
        </div>
      )
    },
    {
  ...
  if (loading && displayOrders.length === 0 && orders.length === 0 && activeTab === 'orders') {
    return <Loading />;
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        {!isAccountsManager && !isProductionManager && activeTab === 'orders' && (
          <Button
            ...
            <button
              ...
              className={`${
                activeTab === 'verifications'
                  ? 'border-[#8bc34a] text-[#8bc34a]'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
              } whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors flex items-center space-x-2 relative`}
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4">
            <StatCard
              ...
              value={verificationStats.total || 0}
              icon={HiShieldCheck}
              gradient="blue"
            ...
            <StatCard
              title="Approved"
              value={verificationStats.approved || 0}
              icon={HiCheckCircle}
              gradient="green"
              loading={verificationStatsLoading}
            />
            <StatCard
              title="Rejected"
              value={verificationStats.rejected || 0}
              icon={HiXCircle}
              gradient="red"
              loading={verificationStatsLoading}
            />
          ...
          <div className="bg-white">
            <Table
              ...
              loading={paymentVerificationLoading}
              error={paymentVerificationError}
              pagination={paymentVerificationPagination ? {
                ...paymentVerificationPagination,
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div><span className="font-medium">Amount:</span> {formatVerificationCurrency(selectedVerification.currentAmountReceived)}</div>
                  ...
                  <div className="border-t border-gray-200 pt-3">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div><span className="font-medium">Amount:</span> <span className="text-green-700">{formatVerificationCurrency(selectedVerification.requestedAmountReceived)}</span></div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 space-y-3">
                  ...
                  <div className="border-t border-gray-200 pt-3">
                    ...
                    <div className="space-y-1 text-sm">
                      ...
                      <div><span className="font-medium">Amount:</span> {formatVerificationCurrency(selectedVerification.requestedAmountReceived)}</div>
                    </div>
                  </div>
                </div>
                <div>
