...
const ReceivedGoodsPageSimple = () => {
  ...
  // Load data on mount
  useEffect(() => {
    console.log('ReceivedGoodsPageSimple: Component mounted, loading data...');
    const params = {
      page: currentPage,
      limit: 10,
      search: searchTerm,
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      console.log('ReceivedGoodsPageSimple: Filters changed, loading data...');
      const params = {
        page: currentPage,
        limit: 10,
        search: searchTerm,
...
export default ReceivedGoodsPageSimple;
