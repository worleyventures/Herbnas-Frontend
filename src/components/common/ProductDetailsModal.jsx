      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-4">
            <div className="h-16 w-16 rounded-xl bg-gradient-to-br from-[#22c55e]/10 to-[#16a34a]/10 flex items-center justify-center">
              <HiDocumentText className="h-8 w-8 text-[#22c55e]" />
            </div>
            <div>
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                  product.currentStage === 'completed' ? 'bg-green-100 text-green-800' :
